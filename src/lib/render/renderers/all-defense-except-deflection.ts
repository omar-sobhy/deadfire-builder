...
export default class AllDefenseExceptDeflection extends Renderer {
  public override readonly type = StatusEffectType.AllDefenseExceptDeflection;
  ...
  public override async _renderString(statusEffect: StatusEffectDto): Promise<string> {
    ...
    return `${direction} all defenses except deflection by ${statusEffect.baseValue} ${duration}`;
  }
}
