...
export default class AllAccuracy extends Renderer {
  public override readonly type = StatusEffectType.AllAccuracy;
  ...
  public override async _renderString(statusEffect: StatusEffectDto): Promise<string> {
    ...
    return `${direction} accuracy by ${statusEffect.baseValue} ${duration}`;
  }
}
