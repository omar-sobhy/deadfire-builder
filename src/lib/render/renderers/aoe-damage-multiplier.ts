...
export default class AOEDamageMultiplier extends Renderer {
  public override readonly type = StatusEffectType.AOEDamageMultiplier;
  ...
  public override async _renderString(statusEffect: StatusEffectDto): Promise<string> {
    ...
    return `Multiply all AoE damage by ${statusEffect.baseValue} ${duration}`;
  }
}
